...
oadm router default-router --stats-password='maltron' --selector='host=infra' --replicas=1 --service-account=router --images='registry.access.redhat.com/openshift3/ose-${component}:${version}'
